...
const Newsletter = () => {
  return (
    <section className="flex flex-col justify-around items-center text-center py-10 gap-4 bg-slate-100 px-1/5 mt-10">
      <h2 className="font-bold text-lg  text-center">Subcribe to get Weekly Coupons</h2>
